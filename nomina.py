# ==============================================================================
# SISTEMA DE NÓMINA - CIPA SAN JACINTO 2
# Universidad de Cartagena | Fundamentos de Programación | Unidad 3
# ==============================================================================
#
# PRINCIPIOS SOLID APLICADOS:
#   S - Single Responsibility : Cada clase tiene una única responsabilidad.
#   O - Open/Closed           : Empleado está cerrada a modificación; se extiende
#                               creando subclases sin alterar el código base.
#   L - Liskov Substitution   : Toda subclase reemplaza a Empleado sin romper
#                               el comportamiento esperado en Nomina.
#   I - Interface Segregation : ABC separadas: CalculadorSalario, CalculadorBonos,
#                               CalculadorDeducciones.
#   D - Dependency Inversion  : Empleado recibe ServicioDeducciones por inyección,
#                               dependiendo de la abstracción, no de la clase concreta.
# ==============================================================================
